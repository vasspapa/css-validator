...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
	<head>
		...
		<meta name="revision" content="$Id: validator.html.es,v 1.1 2005-01-17 02:24:42 ot Exp $"/>
	</head>
	<body>
		<div id="banner">
			<h1 id="title">
	...
	Disponibles más opciones en el <a href="validator-text">Interfaz avanzado para la introdución directa de CSS</a>.
      ...
      <!-- SSI Template Version: $Id: validator.html.es,v 1.1 2005-01-17 02:24:42 ot Exp $ -->
		</address>
		<p class="copyright">
